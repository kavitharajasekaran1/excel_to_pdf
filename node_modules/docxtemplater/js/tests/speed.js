...
var _require = require("./utils"),
    ...
    browserMatches = _require.browserMatches;
...
describe("Speed test", function () {
  ...
  it("should be fast for nested loop tags", function () {
    ...
    if (browserMatches(/internet explorer (10|11)/) || browserMatches(/iphone 10.3/)) {
      maxDuration = 500;
    }
  ...
  if (!process.env.FAST) {
    ...
    it("should not be slow when having many loops with resolveData", function () {
      ...
      return doc.resolveData(data).then(function () {
        ...
        if (browserMatches(/iphone 10.3/) || browserMatches(/MicrosoftEdge (16|17|18)/)) {
          maxRenderTime = 2000;
        }

        expect(stepRender).to.be.below(maxRenderTime);
        expect(parserCount).to.be.equal(4); // 20**3 + 20**2 *3 + 20 * 2 + 1  = 9241
